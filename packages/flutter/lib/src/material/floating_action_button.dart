...
class FloatingActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool enableFeedback =
        this.enableFeedback ?? floatingActionButtonTheme.enableFeedback ?? true;
    final TextStyle extendedTextStyle = (this.extendedTextStyle ??
            floatingActionButtonTheme.extendedTextStyle ??
            theme.textTheme.button!.copyWith(letterSpacing: 1.2))
    ...
    switch (_floatingActionButtonType) {
      case _FloatingActionButtonType.regular:
        sizeConstraints =
            floatingActionButtonTheme.sizeConstraints ?? _kSizeConstraints;
        break;
      ...
      case _FloatingActionButtonType.extended:
        ...
        final EdgeInsetsGeometry padding = extendedPadding ??
            ...
            EdgeInsetsDirectional.only(
                start: child != null && isExtended ? 16.0 : 20.0, end: 20.0);
