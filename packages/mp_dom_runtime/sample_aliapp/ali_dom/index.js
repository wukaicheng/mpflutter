...
class _Element extends EventEmitter {
            ...
            setTimeout(() => {
                _Element.classBoundingClientRectQuery[className].exec((result) => {
                    ...
                    for (let index = 0; index < result[0].length; index++) {
                        ...
                        (_b = (_a = _Element.classBoundingClientRectCallback)[it.dataset.id]) === null || _b === void 0 ? void 0 : _b.call(_a, {
                            width: it.width,
                            height: it.height,
                        });
    ...
    get windowPaddingBottom() {
        var _a, _b;
        return (_b = (_a = my.getSystemInfoSync().safeArea) === null || _a === void 0 ? void 0 : _a.bottom) !== null && _b !== void 0 ? _b : 0;
    }
